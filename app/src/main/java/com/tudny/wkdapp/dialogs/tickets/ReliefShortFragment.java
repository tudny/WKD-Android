...
public class ReliefShortFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState){
		...
		builder.setItems(WKDTickets.Relief.getArrayOfNamesShort(), (dialog, which) -> {
			relief = WKDTickets.Relief.getArrayOfReliefsShort()[which];
