...
public class ReliefMiddleFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState){
		...
		builder.setItems(WKDTickets.Relief.getArrayOfNamesMiddle(), (dialog, which) -> {
			relief = WKDTickets.Relief.getArrayOfReliefsMiddle()[which];
