...
public class PeriodNamedFragment extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState){
		...
		builder.setItems(WKDTickets.Period.getArrayOfPeriodNamedNames(), (dialog, which) -> {
			period = WKDTickets.Period.getArrayOfPeriodsNamed()[which];
